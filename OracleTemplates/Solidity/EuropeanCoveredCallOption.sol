...
contract EuropeanCoveredCallOption is ChainlinkClient, ConfirmedOwner {
    ...
    uint256 private escrowAmount = 1000 * 10 ** 18; // 1000 XTZ equivalent in wei
    ...
    */ 
    constructor (
        ...
        // chainlink settings
        setChainlinkToken(0xf390830DF829cf22c53c8840554B98eafC5dCBc2); 
        setChainlinkOracle(0x49484Ae8646C12A8A68DfE2c978E9d4Fa5b01D16); 
        jobId = "7d80a6386ef543a3abb52817f6707e3b"; 
        ...
        _seller.transfer(escrowAmount); //transfer XTZ to contract
    }
    ...
    function fulfill(bytes32 _requestId, bytes memory data) public recordChainlinkFulfillment(_requestId) {
        ...
        ethPrice = getSlice(2, 5, ethPrice);

        currentPrice = strToUint(ethPrice) * 10 ** 18;
    }
    ...
    */ 
    ...
    function enterContract() external payable {
        ...
        seller.transfer(contractPremium); // transfer premium to seller
